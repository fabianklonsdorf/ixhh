  ...
  describe('Renders as expected', function () {
    ...
    describe('selectContainer', function () {
      ...
      it('renders the down arrow icon', function () {
        expect(selectContainer.find(!_FeatureFlags.componentsX ? _Icon.default : _index.default).length).toEqual(1);
      });
      ...
      it('should have iconDescription match Icon component description prop', function () {
        var description = !_FeatureFlags.componentsX ? wrapper.find(_Icon.default).props().description : wrapper.find(_index.default).props()['aria-label'];
