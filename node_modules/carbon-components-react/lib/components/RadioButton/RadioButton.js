...
function (_React$Component) {
  ...
  _createClass(RadioButton, [{
    ...
    value: function render() {
      ...
      var wrapperClasses = (0, _classnames.default)(className, "".concat(prefix, "--radio-button-wrapper"), (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefix, "--radio-button-wrapper--label-").concat(labelPosition), labelPosition !== 'right'), _defineProperty(_classNames2, "radioButtonWrapper", !_FeatureFlags.breakingChangesX), _classNames2));
