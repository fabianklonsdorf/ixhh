...
var _ = _interopRequireDefault(require("@carbon/icons-react/lib/caret--right/24"));

var _2 = _interopRequireDefault(require("@carbon/icons-react/lib/caret--left/24"));
...
describe('Pagination', function () {
  describe('renders as expected', function () {
    ...
    describe('icons', function () {
      var iconTypes = !_FeatureFlags.componentsX ? [_Icon.default] : [_2.default, _.default];
    ...
    describe('pagination size container', function () {
      ...
      it('should support translated label with colon', function () {
        if (!_FeatureFlags.componentsX) {
          ...
          var label = pagination.find('.bx--pagination__left').find('.bx--pagination__text').first();
      ...
      it('should show the item range out of the total', function () {
        ...
        expect(label.text()).toBe(!_FeatureFlags.componentsX ? "\xA0|\xA0\xA01\u20135 of 50 items" : '1–5 of 50 items');
      });
      describe('pagination size container when total pages unknown', function () {
        ...
        it('should show the item range without the total', function () {
          var label = left.find('.bx--pagination__text').at(1);
          expect(label.text()).toBe(!_FeatureFlags.componentsX ? "\xA0|\xA0\xA01\u20135 items" : '1–5 items');
        });
      });
      describe('pagination sizing', function () {
        it('should respond to page size changes', function () {
          ...
          expect(labels.at(1).text()).toBe(!_FeatureFlags.componentsX ? "\xA0|\xA0\xA01\u201310 of 50 items" : '1–10 of 50 items');
          expect(labels.at(2).text()).toBe(!_FeatureFlags.componentsX ? '1 of 5 pages' : 'of 5 pages');
        });
    ...
    describe('pagination paging container', function () {
      ...
      it('should show the current page out of the total number of pages', function () {
        ...
        expect(label.text()).toBe(!_FeatureFlags.componentsX ? '1 of 10 pages' : 'of 10 pages');
      });
      it('should render ranges and pages for no items', function () {
        ...
        var labels = pager.find('.bx--pagination__text');
        expect(labels.at(1).text()).toBe(!_FeatureFlags.componentsX ? "\xA0|\xA0\xA00\u20130 of 0 items" : '0–0 of 0 items');
        expect(labels.at(2).text()).toBe(!_FeatureFlags.componentsX ? '1 of 1 pages' : 'of 1 pages');
      });
      ...
      describe('pagination paging container when total pages unknown', function () {
        ...
        it('should not append `pagination__button--no-index` class if input is disabled', function () {
          ...
          var forwardButton = pagination.find('.bx--pagination__button--forward');
          var backwardButton = pagination.find('.bx--pagination__button--backward');
          expect(backwardButton.hasClass('bx--pagination__button--no-index')).toEqual(false);
          expect(forwardButton.hasClass('bx--pagination__button--no-index')).toEqual(false);
        });
      });
