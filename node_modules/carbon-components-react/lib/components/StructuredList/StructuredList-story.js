...
(0, _react2.storiesOf)('StructuredList', module).add('Simple', function () {
  ...
  var structuredListBodyRowGenerator = function structuredListBodyRowGenerator(numRows) {
    ...
    return Array.apply(null, Array(numRows)).map(function (n, i) {
      ...
      }, _FeatureFlags.componentsX ? [].concat(_toConsumableArray(structuredListBodyColumns(i)), [checkbox(i)]) : [checkbox(i)].concat(_toConsumableArray(structuredListBodyColumns(i))));
    });
  };
  ...
  return _react.default.createElement(_StructuredList.StructuredListWrapper, {
    ...
    head: true
  }, _FeatureFlags.componentsX ? [].concat(structuredListHeadColumns, [emptyStructuredListHeadCell]) : [emptyStructuredListHeadCell].concat(structuredListHeadColumns))), _react.default.createElement(_StructuredList.StructuredListBody, null, structuredListBodyRowGenerator(4)));
}, {
  info: {
