...
function (_PureComponent) {
  ...
  _createClass(Slider, [{
    ...
    value: function componentDidMount() {
      if (!_FeatureFlags.sliderValuePropSync) {
        this.updatePosition();
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
      ...
      }, _FeatureFlags.componentsX && _react.default.createElement("span", {
        ...
        className: "".concat(prefix, "--slider__range-label")
      }, formatLabel(min, minLabel)), _react.default.createElement("span", {
        className: "".concat(prefix, "--slider__range-label")
