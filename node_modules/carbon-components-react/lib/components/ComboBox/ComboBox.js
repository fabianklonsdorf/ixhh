  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "disabled", "id", "items", "itemToString", "titleText", "helperText", "placeholder", "initialSelectedItem", "ariaLabel", "translateWithId", "invalid", "invalidText", "light", "type", "shouldFilterItem", "onChange", "onInputChange"]);

      var className = (0, _classnames.default)("".concat(prefix, "--combo-box"), containerClassName, _defineProperty({}, "".concat(prefix, "--form-item"), !_FeatureFlags.componentsX));
      ...
      var input = _react.default.createElement(_downshift.default, {
