...
var _2 = _interopRequireDefault(require("@carbon/icons-react/lib/error--filled/20"));

var _3 = _interopRequireDefault(require("@carbon/icons-react/lib/checkmark--filled/20"));

var _4 = _interopRequireDefault(require("@carbon/icons-react/lib/warning--filled/20"));
...
var didWarnAboutDeprecationButtonIcon = false;
  ...
  _createClass(NotificationButton, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["ariaLabel", "className", "iconDescription", "type", "icon", "renderIcon", "name", "notificationType"]);

      if (process.env.NODE_ENV !== "production" && _FeatureFlags.breakingChangesX && (icon || name)) {
        process.env.NODE_ENV !== "production" ? (0, _warning.default)(didWarnAboutDeprecationButtonIcon, 'The `icon`/`name` properties in the `NotificationButton` component is being removed in the next release of ' + '`carbon-components-react`. Please use `renderIcon` instead.') : void 0;
...
var useIcon = function useIcon(kindProp) {
  return {
    error: _FeatureFlags.componentsX ? _2.default : _carbonIcons.iconErrorSolid,
    success: _FeatureFlags.componentsX ? _3.default : _carbonIcons.iconCheckmarkSolid,
    warning: _FeatureFlags.componentsX ? _4.default : _carbonIcons.iconWarningSolid,
    info: _FeatureFlags.componentsX ? null : _carbonIcons.iconInfoSolid
  }[kindProp];
};
...
var NotificationIcon = function NotificationIcon(_ref) {
  ...
  if (!_FeatureFlags.componentsX) {
    if (notificationType === 'inline') {
      switch (kind) {
        case 'warning':
          return (0, _a11yIconWarningSolid.default)(prefix, notificationType);
  ...
  return NotificationIconX && _react.default.createElement(NotificationIconX, {
...
function (_Component3) {
  ...
  _createClass(ToastNotification, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--toast-notification"), _defineProperty({}, "".concat(prefix, "--toast-notification--").concat(this.props.kind), this.props.kind), className);
      return _react.default.createElement("div", _extends({}, other, {
        role: role,
        kind: kind,
        className: classes
...
function (_Component4) {
  ...
  _createClass(InlineNotification, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--inline-notification"), _defineProperty({}, "".concat(prefix, "--inline-notification--").concat(this.props.kind), this.props.kind), className);
      return _react.default.createElement("div", _extends({}, other, {
        role: role,
        kind: kind,
        className: classes
...
var didWarnAboutDeprecationNotification = false; // Deprecated
...
function (_Component5) {
  ...
  function Notification() {
    ...
    _defineProperty(_assertThisInitialized(_this4), "handleCloseButtonClick", function (evt) {
      _this4.setState({
        open: false
      });
    ...
    _defineProperty(_assertThisInitialized(_this4), "useIcon", function (kindProp) {
      return {
  ...
  _createClass(Notification, [{
    ...
    value: function render() {
      if (process.env.NODE_ENV !== "production") {
        process.env.NODE_ENV !== "production" ? (0, _warning.default)(didWarnAboutDeprecationNotification, 'The `Notification` component is being removed in the next release of ' + '`carbon-components-react`. Please use `InlineNotification` or `ToastNotification` instead.') : void 0;
      ...
      var notificationClasses = {
        toast: (0, _classnames.default)("".concat(prefix, "--toast-notification"), _defineProperty({}, "".concat(prefix, "--toast-notification--").concat(this.props.kind), this.props.kind), className),
        inline: (0, _classnames.default)("".concat(prefix, "--inline-notification"), _defineProperty({}, "".concat(prefix, "--inline-notification--").concat(this.props.kind), this.props.kind), className)
      };
...
var _default = !_FeatureFlags.breakingChangesX ? Notification : null;
