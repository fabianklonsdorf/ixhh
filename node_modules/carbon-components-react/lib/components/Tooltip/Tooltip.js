...
function (_Component) {
  ...
  function Tooltip() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyPress", function (event) {
      if ((0, _key2.matches)(event, [_key2.keys.ESC, _key2.keyCodes.ESC, _key2.keyCodes.IEESC])) {
      ...
      if ((0, _key2.matches)(event, [_key2.keys.ENTER, _key2.keyCodes.ENTER, _key2.keys.SPACE, _key2.keyCodes.SPACE])) {
        event.stopPropagation();
    ...
    _defineProperty(_assertThisInitialized(_this), "handleEscKeyPress", function (event) {
      ...
      if (open && (0, _key2.matches)(event, [_key2.keys.ESC, _key2.keyCodes.ESC, _key2.keyCodes.IEESC])) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["triggerId", "tooltipId", "children", "className", "triggerClassName", "direction", "triggerText", "showIcon", "icon", "iconName", "iconDescription", "renderIcon", "menuOffset", "clickToOpen", "tabIndex", "innerRef"]);
      ...
      }, properties), IconCustomElement ? _react.default.createElement(IconCustomElement, _extends({
        ref: refProp
      }, iconProperties)) : _react.default.createElement(_Icon.default, _extends({
