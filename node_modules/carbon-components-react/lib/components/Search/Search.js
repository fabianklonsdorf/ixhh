...
var _2 = _interopRequireDefault(require("@carbon/icons-react/lib/close/16"));

var _3 = _interopRequireDefault(require("@carbon/icons-react/lib/close/20"));
...
function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      var searchClasses = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--search"), true), _defineProperty(_classNames, "".concat(prefix, "--search--").concat(_FeatureFlags.componentsX ? 'xl' : 'lg'), !small), _defineProperty(_classNames, "".concat(prefix, "--search--sm"), small), _defineProperty(_classNames, className, className), _classNames));
      ...
      var CloseIconX = !small ? _3.default : _2.default;
      ...
      }, _FeatureFlags.componentsX ? _react.default.createElement(CloseIconX, {
        "aria-label": closeButtonLabelText,
        role: "img"
      }) : _react.default.createElement(_Icon.default, {
