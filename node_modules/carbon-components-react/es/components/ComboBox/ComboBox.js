...
function (_React$Component) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var className = cx("".concat(prefix, "--combo-box"), containerClassName, _defineProperty({}, "".concat(prefix, "--form-item"), !componentsX));
      ...
      var input = React.createElement(Downshift, {
