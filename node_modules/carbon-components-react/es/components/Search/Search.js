...
function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      var searchClasses = classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--search"), true), _defineProperty(_classNames, "".concat(prefix, "--search--").concat(componentsX ? 'xl' : 'lg'), !small), _defineProperty(_classNames, "".concat(prefix, "--search--sm"), small), _defineProperty(_classNames, className, className), _classNames));
      ...
      }, componentsX ? React.createElement(Search16, {
      ...
      }, componentsX ? React.createElement(CloseIconX, {
        "aria-label": closeButtonLabelText,
        role: "img"
      }) : React.createElement(Icon, {
        icon: iconCloseSolid,
