  ...
  describe('Renders as expected', function () {
    ...
    describe('selectContainer', function () {
      ...
      it('renders the down arrow icon', function () {
        expect(selectContainer.find(!componentsX ? Icon : ChevronDownGlyph).length).toEqual(1);
      });
      ...
      it('should have iconDescription match Icon component description prop', function () {
        var description = !componentsX ? wrapper.find(Icon).props().description : wrapper.find(ChevronDownGlyph).props()['aria-label'];
