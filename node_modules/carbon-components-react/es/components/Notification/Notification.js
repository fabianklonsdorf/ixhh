...
function (_Component) {
  ...
  _createClass(NotificationButton, [{
    ...
    value: function render() {
      ...
      if (process.env.NODE_ENV !== "production" && breakingChangesX && (icon || name)) {
        process.env.NODE_ENV !== "production" ? warning(didWarnAboutDeprecationButtonIcon, 'The `icon`/`name` properties in the `NotificationButton` component is being removed in the next release of ' + '`carbon-components-react`. Please use `renderIcon` instead.') : void 0;
...
var NotificationIcon = function NotificationIcon(_ref) {
  ...
  return NotificationIconX && React.createElement(NotificationIconX, {
  ...
  _createClass(Notification, [{
    ...
    value: function render() {
      if (process.env.NODE_ENV !== "production") {
        process.env.NODE_ENV !== "production" ? warning(didWarnAboutDeprecationNotification, 'The `Notification` component is being removed in the next release of ' + '`carbon-components-react`. Please use `InlineNotification` or `ToastNotification` instead.') : void 0;
