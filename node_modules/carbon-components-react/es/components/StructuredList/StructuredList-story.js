...
storiesOf('StructuredList', module).add('Simple', function () {
  ...
  var structuredListBodyRowGenerator = function structuredListBodyRowGenerator(numRows) {
    ...
    return Array.apply(null, Array(numRows)).map(function (n, i) {
      ...
      }, componentsX ? [].concat(_toConsumableArray(structuredListBodyColumns(i)), [checkbox(i)]) : [checkbox(i)].concat(_toConsumableArray(structuredListBodyColumns(i))));
    });
  };
  ...
  return React.createElement(StructuredListWrapper, {
    ...
    head: true
  }, componentsX ? [].concat(structuredListHeadColumns, [emptyStructuredListHeadCell]) : [emptyStructuredListHeadCell].concat(structuredListHeadColumns))), React.createElement(StructuredListBody, null, structuredListBodyRowGenerator(4)));
}, {
  info: {
