...
function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      return componentsX ? React.createElement("div", _extends({
      ...
      }, React.createElement(CaretRight24, null)))) : React.createElement("div", _extends({
        className: classNames
      }, other), React.createElement("div", {
        className: "".concat(prefix, "--pagination__left")
      }, React.createElement("span", {
      ...
      }, pageRange, React.createElement("button", {
        className: backButtonClasses,
        onClick: this.decrementPage,
        "aria-label": backwardText,
...
_defineProperty(Pagination, "defaultProps", {
  ...
  pageRangeText: function pageRangeText(current, total) {
    return componentsX ? "of ".concat(total, " pages") : "".concat(current, " of ").concat(total, " pages");
  },
  disabled: false,
  page: 1,
  pagesUnknown: false,
